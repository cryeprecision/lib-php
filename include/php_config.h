...
#define PHP_BUILD_SYSTEM "Linux mx 4.19.0-17-amd64 #1 SMP Debian 4.19.194-3 (2021-07-18) x86_64 GNU/Linux"
...
/* uname -a output */
#define PHP_UNAME "Linux mx 4.19.0-17-amd64 #1 SMP Debian 4.19.194-3 (2021-07-18) x86_64 GNU/Linux"
